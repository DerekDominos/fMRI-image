...
class Clipper(torch.nn.Module):
    def __init__(self, clip_variant, clamp_embs=False, norm_embs=False,
        ...
        if clip_variant=="ViT-L/14" and hidden_state:
            ...
            image_encoder = CLIPVisionModelWithProjection.from_pretrained("/opt/data/private/fMRI-reconstruction-NSD/cache/openai-clip-vit-large-patch14").eval()
...
class BrainDiffusionPriorOld(DiffusionPrior):
    ...
    def from_pretrained(net_kwargs={}, prior_kwargs={}, voxel2clip_path=None, ckpt_dir='./checkpoints'):
        ...
        import requests
        import json
        config_url = "/opt/data/private/fMRI-reconstruction-NSD/cache/openai-clip-vit-large-patch14/snapshots/32bd64288804d66eefd0ccbe215aa642df71cc41/config.json"
